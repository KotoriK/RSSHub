        ...
        if (historyPushes.unshift(
            {
                ...
                ${Statistics.countRemark===''?'':'<br>'+addUpdatedSign('countRemark')}
                <br>${(function (oldData, newDataC, countAnalyze) {
                    ...
                    <br>较昨日增加:确诊${Statistics.confirmedIncr}例 疑似${Statistics.suspectedIncr}例 重症${Statistics.seriousIncr}例 治愈${Statistics.curedIncr}例 死亡${Statistics.deadIncr}例
